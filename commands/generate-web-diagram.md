...
Create a descriptive subdirectory under `~/Git/maps/` and write the HTML file inside it (e.g., `~/Git/maps/topic-name/index.html`). Create the subdirectory if it doesn't exist. Open the result in the browser.
