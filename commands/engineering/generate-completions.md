---
description: Generate the ~/.claude/completions.json file for claudit autocomplete. Enables skill/agent autocomplete in claudit comment inputs.
---
...
```json
{
  ...
  "agents": [{ "name": "agent-name", "description": "What it does" }]
}
```
