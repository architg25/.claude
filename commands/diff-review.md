...
Include responsive section navigation. Use diff-style visual language throughout: red for removed/before, green for added/after, yellow for modified, blue for neutral context. Create a descriptive subdirectory under `~/Git/maps/` and write the HTML file inside it. Create the subdirectory if it doesn't exist. Open in browser.
