...
allowed-tools: Read, Glob, Grep, Bash(bash ~/.claude/skills/*/scripts/*), Bash(gh pr *), mcp__code-search__search_code, mcp__code-search__read_file, mcp__code-search__count_matches
---
...
Claude model from `shared:complexity-assessment`. Codex model from `shared:codex-dispatch`.
