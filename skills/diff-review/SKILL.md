...
allowed-tools: Read, Glob, Grep, Bash(codex exec *), Bash(git diff *), Bash(git fetch *), Bash(git rev-parse *), Bash(git symbolic-ref *), Bash(mkdir *), mcp__code-search__search_code, mcp__code-search__read_file, mcp__code-search__count_matches
---
