...
description: Read Backstage techdocs by URL. Use when a user pastes a Backstage URL (https://backstage.spotify.net/docs/...) and wants to read, navigate, or search the documentation. Converts URLs to Code Search MCP queries to find and read the source markdown files.
---
